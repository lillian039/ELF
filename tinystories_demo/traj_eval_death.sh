#!/usr/bin/env bash
# Time-resolved leakage trajectory eval, death env (JAX_PLATFORMS=cuda).
# Usage: bash tinystories_demo/traj_eval_death.sh <gpu> <tag:dir> [...]
set -uo pipefail
cd "$(dirname "$0")/.."
GPU="$1"; shift
